...
function createCarData() {
  // Function to generate initial car data
  return [
    ...
    { id: 8, name: 'Audi A6', type: 'Sedan', color: 'Blue', price: 120000, imageUrl: 'https://via.placeholder.com/150?text=Audi+A6' },
    { id: 9, name: 'Tesla Model X', type: 'SUV', color: 'Black', price: 75000, imageUrl: 'https://via.placeholder.com/150?text=Tesla+Model+X' },
    { id: 10, name: 'Tesla Cyber Truck', type: 'Truck', color: 'Red', price: 130000, imageUrl: 'https://via.placeholder.com/150?text=Tesla+Cyber+Truck' },
    { id: 11, name: 'Toyota Corolla', type: 'Sedan', color: 'White', price: 24000, imageUrl: 'https://via.placeholder.com/150?text=Toyota+Corolla' }
  ];
}
